...
class SubscribeForm extends \Elementor\Widget_Base {

	public function get_name() {
		return 'subscribe_form_orions';
	}

	public function get_title() {
		return esc_html__( 'Subscribe From', 'orions' );
	}
  ...
  $this->add_control(
        'r_box_icon',
        [
            'label' => esc_html__( 'Single Icon', 'orions' ),
