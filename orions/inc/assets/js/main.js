...
Array.from(document.querySelectorAll('.menu-item-has-children')).forEach((element, index) => {
    element.addEventListener('click', (e) => {

        if (window.innerWidth > 992) return;

        if (e.target.parentElement.parentElement.classList.contains('menu-item-has-children') || e.target.parentElement.parentElement.classList.contains('parent')) {
            e.preventDefault();
        }
        ...
        Array.from(e.currentTarget.parentElement.querySelectorAll('.menu-item-has-children.dropped')).forEach((e, i) => {
