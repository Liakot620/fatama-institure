...
$error_heading = __( 'We can\'t seem to find any posts regarding the query.', 'orions' );
$error_paragraph = __( 'We’re sorry for the inconvenience. The data you’re looking for doesn’t exist or has been removed. ', 'orions' );
